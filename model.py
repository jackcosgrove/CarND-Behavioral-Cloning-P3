...
def generate_batch_from_file(data, batch_size, mini_batch_size, angle_augmentation, input_shape):
    while 1:
        i = 0
...
flags.DEFINE_float('angle_augmentation', 1.0, "The angle augmentation.")
...
def main(_):
    ...
    model.add(Convolution2D(16, 4, 4, border_mode='valid', input_shape=input_shape))
    ...
    model.fit_generator(generate_batch_from_file(training_data, FLAGS.batch_size, FLAGS.mini_batch_size, FLAGS.angle_augmentation, input_shape),
                        samples_per_epoch=training_samples, nb_epoch=FLAGS.epochs, nb_val_samples=int(training_samples/5),
                        validation_data=generate_batch_from_file(validation_data, FLAGS.batch_size, FLAGS.mini_batch_size, FLAGS.angle_augmentation, input_shape))
